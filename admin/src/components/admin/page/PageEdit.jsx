...
export default function PageEdit({onSuccess}) {
  ...
  const aiWritingAvailable =
    !!siteSettings?.has_openrouter_api_key &&
    !!siteSettings?.ai_default_writing_model_id;
                ...
                record.contents.find(
                  ...
                  <div className="space-y-2 mb-3">
                    <TextInput
                      ...
                      classNames={{
                        input:
                          'text-3xl! font-bold! px-0! border-0! bg-transparent!',
                      }}
                      maxLength={255}
                      size="xl"
                      variant="unstyled"
                      ...
                      <div className="my-4">
                        ...
                        Object.keys(content.content).length > 0 ? (
                          <JSONPageDataEditor
                            ...
                            autoCompleteEnabled={
                              aiAutocompleteEnabled && aiAutoCompleteAvailable
                            }
                          />
                        ) : (
