...
import img005 from "../assets/images/steuerberatung-image-005.png";
      ...
      <section className="w-full px-6 lg:px-[96px] py-[40px] lg:py-[80px]">
        <div className="w-full max-w-[1440px] mx-auto">
          <p className="text-[20px] md:text-[30px] lg:text-[40px] font-normal leading-[1.4] text-[rgba(9,20,35,1)]">
            Für juristische und natürliche Personen im Kanton Bern und darüber
            hinaus: Wir optimieren Ihre Steuersituation, vertreten Sie bei
            Steuerbehörden und sorgen dafür, dass Sie nicht mehr zahlen als
            nötig.
          </p>
        </div>
      </section>
        ...
        <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-[40px] lg:gap-[80px]">
          ...
          <div className="w-full lg:w-[400px] flex-shrink-0">
            ...
            <p className="text-[16px] font-normal leading-[24px] text-white opacity-70 mb-[32px]">
              Mit fundierter Steuerplanung und individueller Beratung helfen wir
              Ihnen, Ihre Steuerlast legal und nachhaltig zu reduzieren — für
          ...
          <div className="w-full lg:flex-1">
            <AccordionItem
              number="01"
              title="Steuerberatung: was dazugehört"
              defaultOpen={true}
            >
              <p className="text-[16px] font-normal leading-[24px] text-white opacity-70">
                Unsere Steuerberatung umfasst die Analyse und Optimierung von
                Steuerfolgen bei geschäftlichen und privaten Entscheidungen. Wir
                begleiten Sie bei Steuerrekursen, führen Abklärungen mit
                Steuerbehörden und erstellen Steuererklärungen für natürliche und
                juristische Personen. Dabei berücksichtigen wir stets die
                aktuellste Rechtsprechung und Gesetzgebung.
              </p>
            </AccordionItem>
          </div>
        </div>
